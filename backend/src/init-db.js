  ...
  try {
    ...
    const defaultUsers = [
      ...
      },
      {
        ...
        password: 'pegawai123',
        fullName: 'Pegawai Kantin 1',
        role: 2, // pegawai
        isActive: true
      },
      {
        username: 'pegawai2',
        email: 'pegawai2@kantinuntung.com',
        password: 'pegawai123',
        fullName: 'Pegawai Kantin 2',
        role: 2, // pegawai
        isActive: true
      }
    ];
    ...
    console.log('   Pegawai 1    - username: pegawai1 password: pegawai123');
    console.log('   Pegawai 2    - username: pegawai2 password: pegawai123');
    console.log('');
